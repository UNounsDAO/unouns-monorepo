export { default as NounsTokenABI } from '../abi/contracts/UNounsToken.sol/UNounsToken.json';
...
export { NounsToken__factory as NounsTokenFactory } from '../typechain/factories/contracts/UNounsToken.sol/NounsToken__factory';
