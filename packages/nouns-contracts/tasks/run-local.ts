...
task(
  ...
  console.log(`UNouns ERC721 address: ${contracts.NounsToken.instance.address}`);
  console.log(`UNouns DAO Executor address: ${contracts.NounsDAOExecutor.instance.address}`);
  console.log(`UNouns DAO Proxy address: ${contracts.NounsDAOProxyV2.instance.address}`);
