 ...
 * the bid amount is not applicable to this auction. (UNounder Noun)
 */
export const BID_N_A = 'n/a';

/**
 * Special Bid type for not applicable auctions (UNounder Nouns)
 */
  ...
  return (
    <Row className={clsx(classes.wrapper, classes.container, classes.section)}>
      ...
      <Col xs="auto" lg={12}>
        ...
        >
          {currentBid === BID_N_A || <TruncatedAmount amount={new BigNumber("0.000000")} /> ? BID_N_A : <TruncatedAmount amount={currentBid && currentBid} />}
        </h2>
      </Col>
    </Row>
  );
