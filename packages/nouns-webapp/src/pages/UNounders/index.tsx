...
import classes from './UNoundersPage.module.css';
import Section from '../../layout/Section';
import { Col, Row, Card } from 'react-bootstrap';
import pfpSola from '../../assets/unounder-pfps/sola221.png';
import pfpAmiyoko from '../../assets/unounder-pfps/amiyoko.png';
import pfpFacuserif from '../../assets/unounder-pfps/facuserif.png';
    ...
    <Section fullWidth={true} className={classes.noundersPage}>
      <Col lg={{ span: 6, offset: 3 }}>
        <h2 style={{ marginBottom: '2rem' }}>
          <Trans>The UNounders</Trans>
        </h2>
        <h3 style={{ marginBottom: '2rem' }}>
          <Trans>2 artists, 1 technologist</Trans>
        </h3>
        ...
        <p style={{ textAlign: 'justify' }}>
          <Trans>
            The UNounders reward is intended as compensation for our pre and post-launch
