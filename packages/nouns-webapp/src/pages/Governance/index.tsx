...
const GovernancePage = () => {
  ...
  const nounSingular = <Trans>UNoun</Trans>;
  const nounPlural = <Trans>UNouns</Trans>;
    ...
    <Section fullWidth={false} className={classes.section}>
      <Col lg={10} className={classes.wrapper}>
        ...
        <p className={classes.subheading}>
          <Trans>
            UNouns govern <span className={classes.boldText}>UNouns DAO</span>. UNouns can vote on
        ...
        <Row className={classes.treasuryInfoCard}>
          ...
          <Col className={classes.treasuryInfoText}>
            <Trans>
              This treasury exists for <span className={classes.boldText}>UNouns DAO</span>{' '}
